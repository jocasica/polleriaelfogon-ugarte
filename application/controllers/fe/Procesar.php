...
class Factura extends CI_Controller {
	...
	$ruc_emisor = "20534172304";
    $emisor['ruc'] = $ruc_emisor;
    $emisor['tipo_doc'] = "6";
    $emisor['nom_comercial'] = "LK COMBUSTIBLES";
    $emisor['razon_social'] = 'LK COMBUSTIBLES S.A.C.';
    $emisor['codigo_ubigeo'] = "150101";
    $emisor['direccion'] = "JR. CAMANA NRO. 615 DPTO. 406";
    $emisor['direccion_departamento'] = 'LIMA';
    $emisor['direccion_provincia'] = 'LIMA';
    $emisor['direccion_distrito'] = 'LIMA';
    $emisor['direccion_codigopais'] = 'PE';
    $emisor['usuariosol'] = 'CRESANDR';
    $emisor['clavesol'] = 'grifolkt';
	...
	if($tipo_comprobante == "01") {
		...
		$resp['ruta_cdr'] = 'archivos_xml_sunat/cpe_xml/beta/20534172304/R-'.$archivo.'.XML';
