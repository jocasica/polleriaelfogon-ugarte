		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					...
					<h6 class="modal-title" style="color:white">Agregar Insumo</h6>
				...
				<div class="modal-body">
					<div class="col-md-12">
						<div class="alert alert-success alert-styled-left alert-arrow-left alert-bordered">
							Agrega un insumo comprado, registrando la cantidad y el precio unitario por el que se compró.
						</div>
					</div>
					<form action="/" id="modal-frm" method="post" accept-charset="utf-8">
						<div class="row">
							<div class="form-group col-md-12">
								<label for="producto_unidadmedida">Insumo</label>
			...
			<div class="col-lg-8 col-xlg-8 col-md-8">
				<div class="card">
					<div class="card-body">
						...
						<form class="form-horizontal form-material" id="frm" method="post" action="<?= base_url('compra/post_insumo') ?>">
