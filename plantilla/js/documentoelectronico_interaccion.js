$(function(){
    ...
    $('input[type=radio][name=tipo_comprobante]').change(function() {
        rellenar_tipo_documento(this.value,$(this).attr('num'));
    });
...
function add_to_detalle() {
    ...
    var data = {
        ...
        descripcion: $('#producto_descripcion option:selected').text().trim(),
        otros: $('#producto_otros').val(),
    ...
    '<td role="gridcell" style="" title="'+$('#producto_descripcion option:selected').text().trim()+'" aria-describedby="detalle_documento_descripcion">'+$('#producto_descripcion option:selected').text().trim()+'</td>'+
    '<td role="gridcell" style="display:none;" title="'+$('#producto_otros').val()+'" aria-describedby="detalle_documento_otros">'+$('#producto_otros').val()+'</td>'+
    ...
    '<td role="gridcell" style="" title="'+$('#producto_unidadmedida').val()+'" aria-describedby="detalle_documento_unidadmedida">'+$('#producto_unidadmedida').val()+'</td>'+
    ...
    '<td role="gridcell" style="text-align:right;" title="'+$('#producto_total').val()+'" aria-describedby="detalle_documento_importe">'+$('#producto_total').val()+'</td>'+
    '<td role="gridcell" style="display:none;" title="'+$('#maquina_id').val()+'" aria-describedby="detalle_documento_maquinaid">'+$('#maquina_id').val()+'</td>'+
...
function rellenar_tipo_documento(tipocomprobante, numero) {
    $("#cliente_tipodocumento").empty();
    $(".content_debito_credito").hide();

    var numaleatorio = numero;
...
function consultar_ruc(ruc) {
    ...
    $.ajax({
        url : 'https://cors-anywhere.herokuapp.com/https://api.sunat.cloud/ruc/'+ruc,
        ...
        $("#cliente_direccion").val(data.domicilio_fiscal);
        console.log(data);
...
function inicializar_tabla_detalle() {
	...
	detalle_documento = detalle_documento.jqGrid({
        ...
        colModel: [
            ...
            { name: 'otros', index: '3', hidden: true },
            ...
            { name: 'maquinaid', index: '8', hidden: true },
            { name: 'estado', index: '9', hidden: true }
