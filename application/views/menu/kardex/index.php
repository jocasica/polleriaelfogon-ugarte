		...
		<div class="row">
            ...
            <div class="form-group">
                <label class="col-md-12">Producto</label>
								<div class="col-sm-12">
									<select name="" class="form-control form-control-line" id="producto_kardex">
                    <option value="1">GASOHOL 90</option>
                    <option value="2">DIESEL B5</option>
                    <option value="3">LUBRICANTE</option>
                  </select>
								</div>
							</div>
							<div class="form-group">
                ...
                <div class="col-sm-12">
									<select name="" class="form-control form-control-line" id="mes_kardex">
                ...
                <div class="col-sm-12">
									<select name="" class="form-control form-control-line" id="ano_kardex">
